						...
						<Paper className={classes.paper}>
							...
							<Card>
								<CardTitle 
									...
									title={this.renderMonthLabel()}/>
								<CardActions>
									<FlatButton label={<span> <MdArrowBack size={20}/> Previous </span>} onClick={this.previous}/>
									<FlatButton label={<span> Next <MdArrowForward size={20}/> </span>} onClick={this.next} />
								</CardActions>
